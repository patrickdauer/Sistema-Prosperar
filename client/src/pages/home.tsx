      ...
      <header style={{ 
        ...
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <h1 className="text-2xl font-bold">
            <span style={{ color: 'white' }}>Sistema Interno </span>
            <span style={{ color: '#22c55e' }}>Prosperar Contabilidade</span>
          </h1>
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Card 
            ...
            <CardContent>
              <p className="text-sm text-white">
                Cadastrar, editar e gerenciar base de clientes
              </p>
            </CardContent>
          </Card>
          ...
          <Card 
            ...
            onClick={() => window.location.href = '/cliente-tasks'}>
            <CardHeader style={{ borderBottom: '1px solid #333' }}>
              <CardTitle className="flex items-center gap-2" style={{ color: '#22c55e' }}>
                <FileText className="h-5 w-5" style={{ color: '#ff8c42' }} />
                Clientes & Tarefas
              ...
              <CardDescription style={{ color: '#888' }}>
                Gestão integrada de clientes e tarefas
              </CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-white">
                Visualizar e gerenciar tarefas por cliente
              </p>
            </CardContent>
          </Card>
          ...
          <Card 
            ...
            onClick={() => window.open('https://drive.google.com/drive/folders/1zyAOSo2-wUHGkPgml8mQDIKL99LGrUIZ', '_blank')}>
            <CardHeader style={{ borderBottom: '1px solid #333' }}>
              <CardTitle className="flex items-center gap-2" style={{ color: '#22c55e' }}>
          ...
          <Card 
            ...
            onClick={() => window.open('https://prosperarcontabilidade.com.br/pix/', '_blank')}>
            <CardHeader style={{ borderBottom: '1px solid #333' }}>
              <CardTitle className="flex items-center gap-2" style={{ color: '#22c55e' }}>
            ...
            <CardContent>
              <p className="text-sm text-white">
                Gerencie chaves PIX e pagamentos instantâneos
              </p>
            </CardContent>
          </Card>
        </div>
